...
require_once(__DIR__ . "/../class/class.Cita.php");
        ...
        if (isset($_GET['getRol'])) {
            ...
            switch ($usuario->idRol) {
                ...
                case 4:
                    ...
                    //Garantizamos que el paciente está en el mismo cupo que los usuarios solicitados
                    $clausulaWhere .= " AND " . $rolSolicitado->tabla . ".idCupo = " . $paciente->getCupo();

                    //Los pacientes pueden consultar medicos de su cupo
