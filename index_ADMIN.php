...
<section class="mt-3">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card bg-light border-warning mb-3" style="max-width: 18rem;">
                    <div class="card-header text-secondary font-weight-bold">Usuarios</div>
                    <div class="card-body">
                        <h3 class="card-title text-center text-warning"><i class="fas fa-users fa-3x"></i></h3>
                        <p class="card-text text-info text-justify"></p>
                    </div>
                    <div class="card-footer text-center"><a href="./usuarios/usuarios.php" type="button" class="btn border-secondary btn-warning"><i class="fas fa-arrow-circle-right"></i></a></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card bg-light border-warning mb-3" style="max-width: 18rem;">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card bg-light border-warning mb-3" style="max-width: 18rem;">
                    <div class="card-header text-secondary font-weight-bold">Pacientes</div>
                    <div class="card-body">
                        <h3 class="card-title text-center text-warning"><i class="fas fa-user-injured fa-3x"></i></h3>
                        <p class="card-text text-info text-justify"></p>
                    </div>
                    <div class="card-footer text-center"><a href="./usuarios/pacientes.php" type="button" class="btn border-secondary btn-warning"><i class="fas fa-arrow-circle-right"></i></a></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card bg-light border-warning mb-3" style="max-width: 18rem;">
